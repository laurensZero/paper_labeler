...
<template>
  <Teleport to="body">
    ...
    >
      <div class="cie-modal" style="backdrop-filter: blur(30px) saturate(180%); -webkit-backdrop-filter: blur(30px) saturate(180%)">
        <!-- Header -->
        <div class="cie-header">
          ...
          <button class="btn-close" @click="onClose" :title="t('cieImport.close')">
