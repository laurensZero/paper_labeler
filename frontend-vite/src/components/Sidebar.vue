...
<template>
  <div class="sidebar-panel">
    ...
    <div class="sidebar-footer">
      ...
      />
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" :disabled="uploading" @click="triggerFileInput" v-tooltip="t('upload.title')">
      ...
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" @click="openCieImport" v-tooltip="t('upload.cieImport')">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" @click="router.push({ name: 'answer-admin' })" v-tooltip="t('paperAdmin.title')">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" @click="router.push({ name: 'compose' })" v-tooltip="t('nav.compose')">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
          <polyline points="14 2 14 8 20 8" />
      ...
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" @click="router.push({ name: 'sections' })" v-tooltip="t('nav.sections')">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
        </svg>
        <span v-if="!props.collapsed" class="footer-btn-label">{{ t('nav.sections') }}</span>
      </button>
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" @click="router.push({ name: 'settings' })" v-tooltip="t('nav.settings')">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <span v-if="!props.collapsed" class="footer-btn-label">{{ t('nav.settings') }}</span>
      </button>
      <div class="sidebar-divider"></div>
      <button class="footer-btn" :class="{ collapsed: props.collapsed }" @click="emit('toggleCollapse')" v-tooltip="props.collapsed ? t('sidebar.expand') : t('sidebar.collapse')">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
