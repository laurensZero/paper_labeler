  ...
  <div class="inspector" :class="{ 'inspector--collapsed': collapsed }">
    ...
    <template v-if="collapsed">
      <div class="inspector-collapsed-actions" @click.self="emit('toggle-collapse')">
        <button v-if="question" class="inspector-icon-btn" @click="emit('toggle-favorite')" v-tooltip="question.is_favorite ? t('inspector.unfavorite') : t('inspector.favorite')">
        ...
        <button v-if="question" class="inspector-icon-btn" @click="collapsedAction('edit')" v-tooltip="t('inspector.editQuestion')">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" />
          </svg>
        </button>
        <button v-if="question" class="inspector-icon-btn" @click="emit('edit-answer')" v-tooltip="t('inspector.editAnswer')">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" />
          </svg>
        </button>
        <button v-if="question" class="inspector-icon-btn" @click="emit('locate')" v-tooltip="t('inspector.locateInPaper')">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>
          </svg>
        </button>
        <button v-if="question" class="inspector-icon-btn" @click="emit('toggle-answer')" v-tooltip="answerButtonText">
        ...
        <button v-if="question" class="inspector-icon-btn inspector-icon-btn--danger" @click="emit('delete')" v-tooltip="t('inspector.delete')">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
